...
namespace ApplyWise.Web.Migrations
{
    ...
    [Migration("20260826111152_ConsolidateAtsAiAndResumeBuildLimits")]
    partial class ConsolidateAtsAiAndResumeBuildLimits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.AiUsageRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.ApplicationImport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("CreatedApplicationId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.ProUpgradeRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("PaymentMethod", "TransactionReference")
                        .IsUnique();
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.ResumeAnalysis", b =>
                {
                    ...
                    b.HasIndex("UserId", "ScoreVersion", "CreatedAt");
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.ResumeBuildUsageRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ResumeBuildUsageRecords");
                });

            modelBuilder.Entity("ApplyWise.Web.Models.ResumeFileCleanup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.UserSubscription", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<DateTimeOffset?>("ProExpiresAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("ProStartedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.ApplicationImport", b =>
                {
                    b.HasOne("ApplyWise.Web.Models.GmailConnection", "GmailConnection")
                        .WithMany("Imports")
            ...
            modelBuilder.Entity("ApplyWise.Web.Models.UserSubscription", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("ApplyWise.Web.Models.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
